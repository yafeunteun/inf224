#############################################################################
# Makefile for building: inf224
# Generated by qmake (3.0) (Qt 5.0.1) on: dim. nov. 3 14:41:10 2013
# Project:  inf224.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile inf224.pro
#############################################################################
...
Makefile: inf224.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/inf2241.0.0 || $(MKDIR) .tmp/inf2241.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/inf2241.0.0/ && (cd `dirname .tmp/inf2241.0.0` && $(TAR) inf2241.0.0.tar inf2241.0.0 && $(COMPRESS) inf2241.0.0.tar) && $(MOVE) `dirname .tmp/inf2241.0.0`/inf2241.0.0.tar.gz . && $(DEL_FILE) -r .tmp/inf2241.0.0
...
main.o: main.cpp multimedia.h \
		photo.h \
		video.h \
		film.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

multimedia.o: multimedia.cpp multimedia.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o multimedia.o multimedia.cpp
...
photo.o: photo.cpp photo.h \
		multimedia.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o photo.o photo.cpp
